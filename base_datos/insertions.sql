...
INSERT INTO base_datos.activities (name, description, age_min, price) VALUES
    ('Moto de nieve', 'Aventura a alta velocidad en senderos nevados', 21, 16000),
    ('Snowboard', 'Estilo libre y descenso en pendientes nevadas', 18, 9000),
    ('Ski', 'Esquí clásico para todos los niveles de experiencia', 18, 18000);


INSERT INTO base_datos.equipment (description, activity_id, price) VALUES
    ('Set Ski (esquís, botas y bastones)', 3, 6150.00),
    ('Set snowboard (tabla y botas)', 2, 8200.00),
    ('Alquiler de moto de nieve (2 horas)', 1, 9840.00),
    ('Casco protector', 1, 1230.00),
    ('Casco protector', 2, 1230.00),
    ('Casco protector', 3, 1230.00),
    ('Gafas para moto de nieve', 1, 1025.00),
    ('Gafas para snowboard', 2, 1025.00),
    ('Gafas para ski', 3, 1025.00),
    ('Esquís', 3, 3690.00),
    ('Botas de ski', 3, 2460.00),
    ('Bastones de ski', 3, 820.00),
    ('Tabla de snowboard', 2, 5740.00),
    ('Botas de snowboard', 2, 2870.00);
